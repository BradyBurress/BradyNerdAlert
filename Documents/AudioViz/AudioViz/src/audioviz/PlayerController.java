...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        timeSlider.valueProperty().addListener(new ChangeListener() {
            ...
            public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                ...
                String time = String.format("%.1f", (timeSlider.getValue())); 
                currentText.setText(time);
                
                Duration durr = new Duration(timeSlider.getValue());
                mediaPlayer.setStartTime(durr);
    ...
    private void handleReady() {
        ...
        String str = String.format("%.1f", (ms)); 
